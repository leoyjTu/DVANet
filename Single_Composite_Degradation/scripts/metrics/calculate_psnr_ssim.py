...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/mnt/nvme0n1/cyn/datasets/Snow100K/test2000/Gt', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/mnt/nvme0n1/cyn/FFTF/results/dual-lora/snow100k', help='Path to restored images')
